...
var Conversation = function Conversation(el) {
  ...
  _defineProperty(this, "display_conversation", function (conversation) {
    ...
    _this2._msg.addEventListener('click', _this2.close_conversation);
  });

  _defineProperty(this, "close_conversation", function () {
    _this2._msg.addEventListener('click', _this2.reopen_conversation);

    _this2._conversation_field.style.display = "none";

    _this2._msg.addEventListener('click', _this2.reopen_conversation);
  });

  _defineProperty(this, "reopen_conversation", function () {
    _this2._msg.removeEventListener('click', _this2.reopen_conversation);

    _this2._conversation_field.style.display = null;
