        ...
        <div>
            <div class="search_compte">
                ...
                <div class="mon_compte">
                    <i class="fas fa-user"></i><a href="">Mon Compte</a>
                </div>
            </div>
            <div>
                <nav class="crumbs">
                    <ul>
                        <li class=""><a href="bikes">Annonces</a></li>
                        <li class=""><a href="bikes/bmx">Produits</a></li>
                        <li class=""><a href="bikes/bmx">Services</a></li>
                    </ul>
                </nav>
            </div>
        </div>
